 ...
 *   https://datatables.net/download/#se-2.2.13/jqc-1.12.4/dt-1.10.20/af-2.3.4/b-1.6.1/cr-1.5.2/fc-3.3.0/fh-3.1.6/kt-2.5.1/r-2.2.3/rg-1.1.1/rr-1.2.6/sc-2.0.1/sl-1.3.1
 *
 * Included libraries:
 *   Semantic UI 2.2.13, jQuery 1 1.12.4, DataTables 1.10.20, AutoFill 2.3.4, Buttons 1.6.1, ColReorder 1.5.2, FixedColumns 3.3.0, FixedHeader 3.1.6, KeyTable 2.5.1, Responsive 2.2.3, RowGroup 1.1.1, RowReorder 1.2.6, Scroller 2.0.1, Select 1.3.1
 */
