...
(function ($) {
    ...
    BootstrapTable.LOCALES['en-US'] = BootstrapTable.LOCALES.en = {
        formatLoadingMessage: function () {
            return 'Đang tải, Vụi lòng đợi ...';
        },
        formatRecordsPerPage: function (pageNumber) {
            return sprintf('%s hàng trên mỗi trang', pageNumber);
        },
        formatShowingRows: function (pageFrom, pageTo, totalRows) {
            return sprintf('Hiển thị %s đến %s của %s hàng', pageFrom, pageTo, totalRows);
        },
        formatDetailPagination: function (totalRows) {
            return sprintf('Đang hiển thị %s hàng', totalRows);
        },
        ...
        formatToggle: function () {
            return 'Đổi kiểu hiển thị';
        },
        formatColumns: function () {
            return 'Chọn cột hiển thị';
        },
